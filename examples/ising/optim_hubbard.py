...
parser.add_argument("--U", type=float, default=8.0, help="Onsite")
parser.add_argument("--P", type=float, default=100.0, help="Penalty")
...
def main():
    ...
    model = hubbard.HUBBARD(tunneling=args.t, onsite=args.U, penalty=args.P)
